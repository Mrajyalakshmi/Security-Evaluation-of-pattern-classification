	...
	<nav>
	  <div id="menubar">
        <ul id="nav">
             ...
             <li><a href="blocked_users.jsp">Blocked Users</a></li>
...
<!--      <div class="slideshow">
	  ...
	  <div id="content">
        <div class="content_item">
                  ...
                  <table>
                      <caption> <h1>New Users</h1></caption>
                      <tr style="background-color: #ffcccc">
                          <td>USERNAME</td><td>NAME</td><td>MAIL</td><td>PHONE NO</td><td>STATUS</td><td>ACTION</td>
                      </tr>
                      <%
Connection con=Dbconnection.getConn();
Statement st=con.createStatement();
ResultSet rt=st.executeQuery("select * from user_reg order by activate");
...
%>
 ...
 if(s.equalsIgnoreCase("yes")){
    status="Deactivate";
    %>
    <td>  <a href="deactivate?<%=id%>">Deactivate</a>   </td>  
                          <%
}
else{
    status="Activate";
     %>
                    <td>  <a href="activate?<%=id%>">Activate</a>   </td>      
