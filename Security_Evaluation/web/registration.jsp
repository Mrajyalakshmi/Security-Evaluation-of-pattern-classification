...
<!--          <li><a href="projects.html">Projects</a></li>
	...
	<div id="site_content">	
      ...
      <div class="slideshow">
	    <ul class="slideshow">
          <li class="show"><img width="900" height="240" src="images/r1.png"/></li>
          <li><img width="900" height="250" src="images/up.png" /></li>
<!--          <li><img width="900" height="250" src="images/home_1.jpg" alt="&quot;Enter your caption here&quot;" /></li>-->
	  ...
	  <div id="content">
        <div class="content_item">
              ...
              <center>
                  <h2 class="title"style="blue: coral">USER &nbsp;REGISTRATION </h2><br>
              </center>
