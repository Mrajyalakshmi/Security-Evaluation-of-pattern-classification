...
<!--          <li><a href="projects.html">Projects</a></li>
	...
	<div id="site_content">	
      ...
      <div class="slideshow">
	    <ul class="slideshow">
          <li class="show"><img width="900" height="250" src="images/w2.png" alt="&quot;face detection&quot;"/></li>
          <li><img width="900" height="250" src="images/w.png" alt="&quot;face detection&quot;" /></li>
<!--          <li><img width="900" height="250" src="images/home_1.jpg" alt="&quot;Enter your caption here&quot;" /></li>-->
    ...
    <footer>
        <p>
            Administrator have to activate and deactivate users by users option, monitor user activities and  find & block attacker in the group. 
        </p>
