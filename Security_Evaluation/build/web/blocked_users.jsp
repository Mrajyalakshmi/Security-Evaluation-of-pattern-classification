...
<!--      <div class="slideshow">
	  ...
	  <div id="content">
        <div class="content_item">
            <table>
		   <caption> <h1>Bloked Users</h1></caption>
                      <tr style="background-color: #ffcccc">
                          <td>USERNAME</td><td>MAIL</td><td>PHONE NO</td><td>ACTION</td>
                      </tr>
                                            <%
Connection con=Dbconnection.getConn();
Statement st=con.createStatement();
ResultSet rt=st.executeQuery("select * from user_reg where count>=3");
